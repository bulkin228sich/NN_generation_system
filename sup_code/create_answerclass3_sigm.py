...
# Пути
data_dir = r'C:\Users\dimon\PycharmProjects\dip\dataset_new\test\data'
answer1_dir = r'C:\Users\dimon\PycharmProjects\dip\dataset_new\test\answer'
output_dir = r'C:\Users\dimon\PycharmProjects\dip\dataset_new\test\answerclass3_sigm'
    ...
    try:
        ...
        with open(output_path, 'w', newline='', encoding='utf-8') as f:
            ...
            for i in range(3):
                ...
                pc = ((answer_values[i] - close_prices) / close_prices) * 100

                # Округление до 2 знаков после запятой
                clamped = max(-1, min(1, pc*4))
                # Нормируем в [0,1]
